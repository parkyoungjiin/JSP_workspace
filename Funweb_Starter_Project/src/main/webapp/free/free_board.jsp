...
List<freeDTO> freelist = dao.selectList(startRow, listLimit, keyword);
...
<body>
	<div id="wrap">
		...
		<article>
			...
			<div id="table_search">
				<input type="button" value="글쓰기" class="btn" onclick="location.href = 'free_writeboard.jsp'">
			</div>
			<div id="table_search">
				<form action="driver_jsp" method="post">
					<input type="text" name="keyword" class="input_box">
					<input type="submit" value="Search" class="btn" onclick = "#">
				</form>
			</div>
